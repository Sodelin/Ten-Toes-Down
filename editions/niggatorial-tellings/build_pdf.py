...
class BookDoc(BaseDocTemplate):
 def beforeDocument(self):self.book_title='THE NIGGATORIAL TELLINGS';self.number=0
...
def page(c,d):
 if d.page==1:
  ...
  c.setFillColor(HexColor('#f3be5b'));c.setFont('SansBold',24);c.drawString(35,338,'THE NIGGATORIAL');c.drawString(35,307,'TELLINGS')
...
doc=BookDoc(str(args.pdf),pagesize=(W,H),leftMargin=45,rightMargin=45,topMargin=51,bottomMargin=47,title='Ten Toes Down: The Niggatorial Tellings',author='ChatGPT for Nolan',subject='A six-book action and romance fanfiction epic',pageCompression=1)
