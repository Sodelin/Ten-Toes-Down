...
files={};groups=[];spine=[]
files['title.xhtml']=page('Ten Toes Down: The Niggatorial Tellings','<section class="title"><h1>Ten Toes Down</h1><h2>The Niggatorial Tellings</h2><p>The complete six-book epic</p><p>Written by ChatGPT for Nolan</p><p>September 2026</p><p>An alternate-universe work of fiction, including invented crossover and alternate-history episodes.</p></section>')
...
metadata='<dc:identifier id="uid">'+uid+'</dc:identifier><dc:title>Ten Toes Down: The Niggatorial Tellings</dc:title><dc:creator>ChatGPT for Nolan</dc:creator><dc:language>en</dc:language><dc:description>An alternate-universe action and romance epic in six books.</dc:description><meta property="dcterms:modified">2026-09-07T00:00:00Z</meta>'
